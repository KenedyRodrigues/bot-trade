...
VALORES_ATUAIS = {
    "15m": {
        "yellow": 10,      # Substitua pelo valor atual
        "cor_especial": "green",  # "green" para LONG ou "blue" para SHORT
        "valor_especial": 20,     # Valor da cor especial (green ou blue)
        "red": 5           # Valor do red
    },
    "3m": {
        "yellow": 8,       # Substitua pelo valor atual
        "cor_especial": "green",  # Deve ser a mesma cor do 15m
        "valor_especial": 15,     # Valor da cor especial
        "red": 10          # Valor do red
    },
    "1m": {
        "yellow": 12,      # Substitua pelo valor atual
        "cor_especial": "green",  # Deve ser a mesma cor do 15m
        "valor_especial": -25,    # Valor da cor especial
        "red": -8          # Valor do red
    }
}
